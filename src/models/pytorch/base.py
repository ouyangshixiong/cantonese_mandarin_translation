...
class PyTorchBaseModel(BaseTranslationModel, nn.Module):
    """Base PyTorch model for translation"""
    ...
    def predict_step(self, batch: Dict[str, torch.Tensor]) -> List[str]:
        """Prediction step"""
        generated_ids = self.generate(
            input_ids=batch["input_ids"],
            attention_mask=batch["attention_mask"]
